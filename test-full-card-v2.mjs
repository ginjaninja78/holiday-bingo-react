...
console.log('Generating full bingo card v2...');
...
// Shuffle and pick 24 random images
...
fs.writeFileSync('/home/ubuntu/full-bingo-card-v2.pdf', pdfBuffer);
console.log('✅ Full bingo card v2 saved to /home/ubuntu/full-bingo-card-v2.pdf');
